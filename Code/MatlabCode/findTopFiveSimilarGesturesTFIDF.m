function topFive = findTopFiveSimilarGesturesTFIDF(Path,FileName,dimensionFolder)
%     calculateTFvaluesForGivenFile(Path,FileName,dimensionFolder,windowSize,shift);
    mkdir(strcat(Path,'\Outputs\Phase2-Task1'),'1B');
...
%        cosSimilarity = dotProduct ./ normProducts;
   ...
   fid=fopen(strcat(Path,'\Outputs\Phase2-Task1\1B\',FileName,'-topFiveFiles-TFIDF.csv'),'wt');
